# Free Science Network - Color Scheme Documentation

## Overview

This document defines the official color scheme for the Free Science Network website. The palette is inspired by the **navbar background image** (`images/navbar-bg.png`), which features a natural landscape with:
